...
public class AnalyzeIncidentWithContext {

  private static final Logger LOGGER = org.slf4j.LoggerFactory.getLogger(AnalyzeIncidentWithContext.class);
  ...
  public static void main(String[] args) throws ConfigurationException {
    ...
    CompletionSKFunction function = skill.getFunction("AnalyzeWithContext", CompletionSKFunction.class);

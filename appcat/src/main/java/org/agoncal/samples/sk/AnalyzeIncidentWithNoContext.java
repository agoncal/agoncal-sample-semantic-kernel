...
public class AnalyzeIncidentWithNoContext {

  private static final Logger LOGGER = org.slf4j.LoggerFactory.getLogger(AnalyzeIncidentWithNoContext.class);
  ...
  public static void main(String[] args) throws ConfigurationException {
    ...
    CompletionSKFunction function = skill.getFunction("AnalyzeWithNoContext", CompletionSKFunction.class);

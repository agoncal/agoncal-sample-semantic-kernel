...
public class SummarizeTasks {
  ...
  private static final Logger LOGGER = org.slf4j.LoggerFactory.getLogger(SummarizeTasks.class);
  ...
  public static void main(String[] args) throws ConfigurationException {
    ...
    TextCompletion textCompletion = SKBuilders
      ...
      .withModelId("deploy-semantic-kernel-16k")
      .build();
    ...
    CompletionSKFunction function = skill.getFunction("SummarizeTasks", CompletionSKFunction.class);

    // Asks for an analysis
    Mono<SKContext> result = function.invokeAsync();

    LOGGER.info("The main tasks are: \n\n{}", result.block().getResult());
  }
